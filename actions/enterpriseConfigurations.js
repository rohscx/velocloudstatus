...
module.exports = async function (data){
    return new Promise((resolve,reject) => {
        ...
        if (!getEnterprises) reject({rejected:["enterpriseData.js","bad data"," const getEnterprises = data;"]});
        const getEnterpriseEdges = Promise.all(getEnterprises.map( async (d) => {
            ...
            const route = 'https://vco18-usvi1.velocloud.net/portal/rest/enterprise/getEnterpriseConfigurations';
